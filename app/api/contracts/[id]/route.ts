    ...
    try {
        ...
        return NextResponse.json({
            contract: {
                ...
                performanceBondAmount: row.performance_bond_amount ? Number(row.performance_bond_amount) : null,
    ...
    try {
        ...
        const result = await pool.query(
            `UPDATE we_contracts SET
                ...
                supply_amount         = $7,
                stamp_duty            = $8,
                performance_bond_amount = $9,
                performance_bond_rate = $10,
                defect_bond_rate      = $11,
                payment_schedule      = $12,
                contract_notes        = $13,
                contract_date         = $14,
                contract_start_date   = $15,
                contract_end_date     = $16,
