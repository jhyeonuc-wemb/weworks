...
const cards = [
  {
    ...
    label: "Projects",
    title: "프로젝트 아카이브",
    description: "전체 프로젝트 Lifecycle 및 히스토리를 한눈에 조망합니다.",
    href: "/projects",
    color: "slate",
    stats: "24 Active"
  },
  {
    ...
    label: "Delivery",
    title: "프로젝트 실행 엔진",
    description: "실시간 프로젝트 추적, 진행율 및 리스크를 체계적으로 모니터링합니다.",
    href: "/delivery",
    color: "blue",
    stats: "92% Velocity"
  },
    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      <section className="space-y-4 max-w-4xl">
        ...
        <h1 className="text-4xl font-black tracking-tight text-slate-900 md:text-5xl italic">
          WEWORKS <span className="text-slate-200 font-extralight not-italic">|</span>프로젝트 통합 관제 보드
        </h1>
