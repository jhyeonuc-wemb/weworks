...
import { Plus, Edit, Trash2, Layers, ChevronLeft, ChevronRight, FolderOpen, GripVertical } from "lucide-react";
import {
    Table,
    TableHeader,
    TableBody,
...
interface ProjectPhase {
    ...
    code: string;
    name: string;
    phase_group: string; // 'sales_ps' | 'project'
    path: string | null;
...
export default function ProjectPhasesPage() {
    ...
    const paginatedPhases = useMemo(() => {
        ...
        return phases.slice(startIndex, startIndex + itemsPerPage);
    }, [phases, currentPage, itemsPerPage]);
                ...
                <div className="overflow-x-auto custom-scrollbar-main">
                    <Table>
                        <TableHeader className="bg-muted/30">
                            <TableRow>
                                <TableHead className="px-2 py-3 text-center text-sm text-slate-900 w-20 whitespace-nowrap">순서</TableHead>
                                <TableHead className="px-8 py-3 text-left text-sm text-slate-900">그룹</TableHead>
                                <TableHead className="px-8 py-3 text-left text-sm text-slate-900">코드(ID)</TableHead>
                                ...
                                <TableHead className="px-8 py-3 text-center text-sm text-slate-900">상태</TableHead>
                        ...
                        <TableBody className="divide-y divide-border/10">
                            {loading ? (
                                <TableRow>
                                    <TableCell colSpan={8} className="px-8 py-24 text-center border-none">
                                    ...
                                    <TableRow key={phase.id} className="hover:bg-primary/[0.02] transition-colors group">
                                        ...
                                        <TableCell className="text-center px-8 py-3">
                                            <div className={cn(
                                                ...
                                                phase.is_active ? "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]" : "bg-gray-300"
                                            )} />
                                        </TableCell>
