    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex items-center justify-between px-2">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-foreground">M/D 산정 항목 관리</h1>
            ...
            {activeCategory && (
                <div className="neo-light-card border border-border/40 overflow-hidden">
                    <div className="p-6 space-y-6">
                        ...
                        {/* 개발 탭: 공통 난이도 산정 + 분야별 난이도 산정 */}
                        {activeCategory.code === "development" && (
                            <>
                                {["development_common_weight", "development_field_weight"].map((weightCode) => {
                                    const weightCategory = categories.find((c) => c.code === weightCode);
                                    if (!weightCategory) return null;
                                    return (
                                        <div key={weightCode} className="mt-6 mb-8">
                                                ...
                                                <table className="min-w-full" style={{ borderCollapse: "collapse" }}>
                                                    ...
                                                    <thead>
                                                        <tr className="h-[35px]">
                                                            ...
                                                            <th className="border border-gray-300 bg-blue-50/50 px-[10px] text-center text-sm font-bold">구분</th>
                                                            <th className="border border-gray-300 bg-blue-50/50 px-[10px] text-left text-sm font-bold">내용</th>
                                                            ...
                                                            <tr key={item.id} className="group">
                                                                ...
                                                                <td className="border border-gray-300 p-0" style={{ lineHeight: 0, fontSize: 0, height: "1px" }}>
                                                                    <input
                                                                        ...
                                                                        onChange={(e) => updateItem(weightCategory.code, item.id, "itemCategory", e.target.value)}
