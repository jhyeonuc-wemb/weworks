...
import { List, Plus, Copy, Save, CheckCircle2, XCircle, Trash2, AlertCircle, HelpCircle, Calendar as CalendarIcon, FileSpreadsheet, Download } from "lucide-react";
...
export interface VrbReviewTabHandle {
  save: () => Promise<void>;
  deleteVrb: () => void;
  complete: () => Promise<void>;
}

interface VrbReviewTabProps {
  projectId: string;
  onStatusChange?: (status: string, vrbId: number | null, reviewResult?: string) => void;
  onTabChange?: (tabId: string) => void;
}

const VrbReviewTab = forwardRef<VrbReviewTabHandle, VrbReviewTabProps>(
            ...
            if (reviews.length > 0) {
              ...
              if (detailResponse.ok) {
                ...
                setVrbData({
                  ...
                  reviewResult: review.review_result || undefined,
                    ...
                    <td className="border border-gray-300 p-0 h-[35px]" colSpan={3}>
                      <div className="flex items-center gap-0.5 h-full">
                        <DatePicker
                          ...
                          buttonClassName="border-none shadow-none w-full h-full rounded-none focus:ring-2 focus:ring-inset focus:ring-blue-500 hover:bg-blue-50 transition-colors justify-start px-[10px] text-sm"
                          mode="month"
                          dateFormat="yyyy-MM"
                          placeholder="YYYY-MM"
                        />
                ...
                <tbody className="bg-white">
                  ...
                  <tr>
                    ...
                    <td colSpan={3} className="border-x-2 border-blue-400 border-b border-gray-300 border-solid p-0 align-top" style={{ borderLeftColor: '#60a5fa', borderRightColor: '#60a5fa', borderBottomColor: '#d1d5db' }}>
                      <div className="flex flex-col w-full min-h-[35px]">
