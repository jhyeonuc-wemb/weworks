                ...
                <div className="flex items-center justify-between">
                    ...
                    {vrbStatus !== "COMPLETED" && (
                        <button
                            ...
                            onClick={handleSave}
                            disabled={saving}
                            className="inline-flex items-center gap-2 rounded-xl bg-gray-900 px-5 h-10 text-sm font-medium text-white hover:bg-gray-800 disabled:opacity-50 disabled:cursor-default transition-colors"
                        >
