...
-- 3. M/D 산정 난이도 항목 (공통)
-- ============================================
71: INSERT INTO we_md_difficulty_items (category, content, description, default_difficulty, display_order) VALUES
72: -- 요구사항
73: ('요구사항', '요구사항 정의서 미제공', '구두/회의 중심 전달', 2, 1),
74: ('요구사항', '요구사항 수시 변경 예상', '스펙 Freeze 어려움', 2, 2),
75: ('요구사항', '고객의 IT 이해도 낮음', '기술적 소통 난이도 상승', 2, 3),
76: ('요구사항', '고객 의사결정자 부재 또는 다수', '승인/결정 지연 가능성', 2, 4),
77: -- 화면, 기능
78: ('화면, 기능', '화면 ≥ 20개', 'CRUD 중심 화면, 팝업포함', 2, 5),
79: ('화면, 기능', '업무 기능 ≥ 5개 모듈로 나눠짐', '업무 도메인 분리가 뚜렷함', 2, 6),
80: ('화면, 기능', '사용자 정의 기능 많음', '워크플로우, 조건부 입력 등', 2, 7),
81: ('화면, 기능', '권한, 조직별 접근 제한 포함', 'Role-based UI 구성 필요', 2, 8),
82: ('화면, 기능', '배치 프로세스 포함', '예약 실행, 로그처리 등 필요', 2, 9),
83: ('화면, 기능', '반응형 지원', '반응형 지원 개발 필요', 2, 10),
84: ('화면, 기능', 'UI/접근성', '모바일 지원 포함 (앱, 웹앱)', 2, 11),
85: -- 연계 및 외부 시스템
86: ('연계 및 외부 시스템', '외부 시스템 연계 ≥ 5개', 'API, DB 연동 등', 2, 12),
87: ('연계 및 외부 시스템', '실시간 연계 포함', 'Webhook, Event 등', 2, 13),
88: ('연계 및 외부 시스템', '레거시 시스템 연계', '명세 미비, 파악 난이도 ↑', 2, 14),
89: ('연계 및 외부 시스템', '인증/SSO 연동 포함', 'AD, OAuth 등', 2, 15),
90: -- 데이터 및 보고서
91: ('데이터 및 보고서', '정형 보고서 ≥ 20건', 'PDF/Excel 출력 등', 2, 16),
92: ('데이터 및 보고서', '대용량 데이터 처리', '100만건 이상', 2, 17),
93: ('데이터 및 보고서', '마이그레이션 포함', '데이터 정제/이관', 2, 18),
94: ('데이터 및 보고서', '정합성 검증 포함', '정확도 중요', 2, 19),
95: -- 기술 환경
96: ('기술 환경', '클라우드 환경 구축', 'AWS, Azure 등', 2, 20),
97: ('기술 환경', 'Hybrid 인프라', '온프 + 클라우드 병행', 2, 21),
98: ('기술 환경', '신규 기술 도입', 'AI, IoT, GIS 등', 2, 22),
99: ('기술 환경', '복잡한 DB (30테이블 이상)', '관계 정규화 + 성능 고려', 2, 23),
100: -- 보안 및 인증
101: ('보안 및 인증', '사용자 권한 분기 3단계 이상', '화면별 권한 설정 필수', 2, 24),
102: ('보안 및 인증', '데이터 암호화 필요', '전송/저장 모두 포함', 2, 25),
103: ('보안 및 인증', '공공기관 보안규격 준수', 'ISMS, CC 등 인증 요건 있음', 2, 26),
104: -- 운영/인력관리
105: ('운영/인력관리', '납기 ≤ 2개월', '기간 촉박', 2, 27),
106: ('운영/인력관리', '프로젝트 기간 ≥ 12개월', '장기 인력 유지/교체 이슈', 2, 28),
107: ('운영/인력관리', '병행 프로젝트 존재', '일정/자원 집중 어려움', 2, 29),
108: ('운영/인력관리', '개발 서버 운영', '운영서버 직접 반영은 어려움', 2, 30),
109: ('운영/인력관리', '고객 내부 승인 절차 복잡', '화면마다 승인 필요', 2, 31),
110: ('운영/인력관리', '주 단위 납품 일정 요구', '세분화된 일정 관리 필요', 2, 32),
111: ('운영/인력관리', '고객사 상주 필수', '피로도, 업무 밀도, 팀 운영 난이도 ↑', 2, 33),
112: ('운영/인력관리', '상주 위치 원거리', '출장, 교통, 숙소 등 추가 리스크', 2, 34),
113: ('운영/인력관리', '외주 인력과의 협업 필수', 'SI 협력사, 고객 IT팀, 프리랜서 등 협조 필요', 2, 35),
114: ('운영/인력관리', '인력 교체 가능성 있음 (예: 6개월 계약)', '인수인계 등 중간 공백 위험 존재', 2, 36),
115: ('운영/인력관리', '고객 내부 정치적 이슈 있음', '팀 변경 등 승인 구조 변경', 2, 37),
116: -- 감리
117: ('감리', '감리 대상 프로젝트, 공공산출물', '일정금액 이상 또는 공공과제', 2, 38),
118: ('감리', '단계별 감리 진행 (4단계 이상)', '분석/설계/개발/종료 감리', 2, 39),
119: ('감리', '감리 전담 인력 부재', '기존 개발팀이 대응까지 담당', 2, 40)
...
('AutoCAD', 'AutoCAD(DWG) 파일 제공', 0.1, 4)
ON CONFLICT (content) DO NOTHING;
