...
-- users (사용자) - 비밀번호는 임시로 'password' (실제 운영 시 해시화 필요)
INSERT INTO users (email, password_hash, name, employee_number, department_id, role_id, position, status) VALUES
('admin@weworks.com', '$2b$10$placeholder', '관리자', 'E001', NULL, (SELECT id FROM roles WHERE name = 'admin'), '시스템 관리자', 'active'),
('hong@weworks.com', '$2b$10$placeholder', '홍길동', 'E002', (SELECT id FROM departments WHERE name = '개발팀'), (SELECT id FROM roles WHERE name = 'pm'), 'PM', 'active'),
('kim@weworks.com', '$2b$10$placeholder', '김철수', 'E003', (SELECT id FROM departments WHERE name = '영업팀'), (SELECT id FROM roles WHERE name = 'sales'), '영업대표', 'active'),
('lee@weworks.com', '$2b$10$placeholder', '이영희', 'E004', (SELECT id FROM departments WHERE name = '개발팀'), (SELECT id FROM roles WHERE name = 'pm'), 'PM', 'active'),
('park@weworks.com', '$2b$10$placeholder', '박민수', 'E005', (SELECT id FROM departments WHERE name = '영업팀'), (SELECT id FROM roles WHERE name = 'sales'), '영업대표', 'active'),
('jung@weworks.com', '$2b$10$placeholder', '정수진', 'E006', (SELECT id FROM departments WHERE name = '개발팀'), (SELECT id FROM roles WHERE name = 'pm'), 'PM', 'active')
ON CONFLICT (email) DO NOTHING;

-- clients (고객사/발주처)
INSERT INTO clients (name, type, code, description) VALUES
...
-- 1. 프로젝트 카테고리
-- ============================================
INSERT INTO project_categories (code, name, description, display_order) VALUES
('energy', 'Energy', '에너지 관련 프로젝트', 1),
('environment', 'Environment', '환경 관련 프로젝트', 2),
('safety', 'Safety', '안전 관련 프로젝트', 3),
('disaster', 'Disaster', '재난 관련 프로젝트', 4),
('other', '기타', '기타 프로젝트', 5);

-- ============================================
-- 2. 인력구분 (M/D 산정용)
-- ============================================
INSERT INTO labor_categories (code, name, description, display_order) VALUES
('PM', 'PM', '프로젝트 매니저', 1),
('개발', '개발', '개발자', 2),
('설계', '설계', '시스템 설계자', 3),
('I/F', 'I/F', '인터페이스 개발자', 4),
('2D디자인', '2D디자인', '2D 디자이너', 5),
('포탈', '포탈', '포탈 개발자', 6),
('QA', 'QA', '품질 보증', 7);
...
-- 3. M/D 산정 난이도 항목 (공통)
-- ============================================
INSERT INTO md_difficulty_items (category, content, description, default_difficulty, display_order) VALUES
-- 요구사항
...
-- 4. M/D 산정 분야별 난이도 항목
-- ============================================
INSERT INTO md_field_difficulty_items (field_category, content, description, default_difficulty, display_order) VALUES
-- 대시보드
...
-- 5. M/D 산정 개발 항목 기준표
-- ============================================
INSERT INTO md_development_items (classification, content, default_quantity, standard_md, display_order) VALUES
-- PM
('PM', 'PM/사업관리', 0, 0, 1),
-- 개발
...
-- 6. M/D 산정 3D 모델링 가중치
-- ============================================
INSERT INTO md_modeling_3d_weights (content, description, weight, display_order) VALUES
('모델링 제공', '배치 등', 0.1, 1),
...
-- 7. M/D 산정 3D 모델링 기준표
-- ============================================
INSERT INTO md_modeling_3d_items (category, difficulty, default_quantity, base_md, remarks, display_order) VALUES
-- 부지
...
-- 8. M/D 산정 P&ID 가중치
-- ============================================
INSERT INTO md_pid_weights (content, description, weight, display_order) VALUES
...
-- 9. M/D 산정 P&ID 기준표
-- ============================================
INSERT INTO md_pid_items (category, default_quantity, base_md, remarks, display_order) VALUES
('P&ID', 500, 1, '', 1),
('SLD', 0, 0.5, '', 2);
