            ...
            <form onSubmit={handleSubmit} className="space-y-2">
                <div className="grid grid-cols-4 gap-x-4 gap-y-2">
                    ...
                    <div className="relative space-y-1 col-span-1">
                        <label className="text-xs font-bold text-gray-500">PM</label>
                        <div className="relative">
                            <input
                                type="text"
                    ...
                    {/* 계약금액 */}
                    <div className="space-y-1 col-span-1">
                        <label className="text-xs font-bold text-gray-500">계약금액(원, VAT별도)</label>
                        <input
                            type="text"
                            value={formData.expectedAmount ? Number(formData.expectedAmount).toLocaleString(undefined, { maximumFractionDigits: 0 }) : ""}
                            onChange={(e) => {
